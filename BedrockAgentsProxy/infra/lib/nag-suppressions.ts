  ...
  NagSuppressions.addResourceSuppressions(
    ...
    [
      ...
      },
      {
        ...
        reason: 'WAF integration not required for demo application',
      },
      {
      ...
      {
        id: 'AwsSolutions-L1',
        reason: 'Lambda part of code base uses latest version. CDK custom resources use older runtime for compatibility',
      },
      ...
      },
      {
        ...
        reason: 'Request validation handled by Express.js application',
      },
      {
      ...
      },
      {
        ...
        reason: 'CloudWatch logging configured at the Lambda level',
      },
    ],
